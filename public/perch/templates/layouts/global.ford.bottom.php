          ...
          <div class="row">
            <div class="col-sm-6 col-md-9">
              <div class="menu-container hidden-xs">
                <?php perch_content('Footer Ford Menu'); ?>
              </div>
    ...
    <div class="modal fade" id="modal-book_service" tabindex="-1" role="dialog" aria-labelledby="modal-book_service-label">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form method="POST" action="/form/book_service" class="form-horizontal">
            <input type="hidden" name="request_page" value="<?=$_SERVER['REQUEST_URI']?>" />
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="modal-book_service-label">Book a Service Enquiry</h4>
            </div>
            <div class="modal-body">

              <div class="row">
                <div class="col-xs-12">
                  <p>Leave your name, phone number and a convenient time, and somebody from our service team will call you!</p>
