...
<script type="text/javascript">
  ...
  function load() {
    map = new google.maps.Map(document.getElementById("map"), {
      center: new google.maps.LatLng(53.114052, -1.299100),
      zoom: 6,
      mapTypeId: 'roadmap',
    ...
    <? foreach($locations as $location) { ?>
      ...
      marker<?=$location['id']?>.addListener('click', function() {
        map.setZoom(15);
        map.setCenter(marker<?=$location['id']?>.getPosition());
      });
      marker<?=$location['id']?>.addListener('mouseover', function() {
        infowindow<?=$location['id']?>.open(map, marker<?=$location['id']?>);
        
      });
      marker<?=$location['id']?>.addListener('mouseout', function() {
    ...
    <div class="col-xs-12 col-md-7">
      ...
      */ ?>
      ...
      <div class="table-responsive" >
        <table class="table table-striped table-bordered" id="LocationDataTable">
          <thead>
            <tr>
              <th>Dealer</th>
              <th>Address</th>
          ...
          <tr>
            ...
            <td style="width: 140px"><?=$location['phone']?></td> 
          </tr>
          <? } ?>
          </tbody>
        </table>
