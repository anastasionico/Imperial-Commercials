...
<html lang="en">
  <head>
    ...
    <title>ImperialDirect - Imperial Commercials</title>
  ...
  <body>
    ...
    <div id="nav-fixed">
      <div class="checkout_header">
        <div class="pull-left">
<?/*          <img src="/assets/img/orwell-logo.png" class="logo"> */ ?>
        </div>
    ...
    <div id="content" class="snap-content"  data-spy="scroll" data-target=".subnav .nav">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-6">
<? /*            <img src="/assets/img/orwell-logo.png" id="logo-sb"> */ ?>
          </div>
          <div class="col-xs-6 text-right">
            <img src="/assets/img/imperial-logo.png" id="logo-mercedes">
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <? if($user['part_option_m1'] == 1 || $user['part_option_m2'] == 1) { ?>
              <li class="dropdown<? if($this->uri->segment(3) == 'quote') echo ' highlight active'; ?>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quote <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <? if($user['part_option_m1'] == 1) { ?><li><a href="/<?=$this->uri->segment(1)?>/parts/quote/1">Mercedes-Benz</a></li><? } ?>
                  <? if($user['part_option_m2'] == 1) { ?><li><a href="/<?=$this->uri->segment(1)?>/parts/quote/2">DAF</a></li><? } ?>
                </ul>
              </li>
              <? } else { ?>
              ...
              <? } ?>
              <li<? if($this->uri->segment(3) == 'imprest') echo ' class="highlight active"'; ?>>
                <a href="/<?=$this->uri->segment(1)?>/parts/imprest">
                  Imprest
                  <span class="childs"></span>
                </a>
              </li>
      ...
      <div class="container">
        <div id="footer" class="links-white">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="right">
                <span class="copyright">&#169; Imperial Commercials <?=date('Y');?></span>
              </div>
            </div><!--/.col-->
          </div><!--/.row-->
        </div><!--/#footer-->
